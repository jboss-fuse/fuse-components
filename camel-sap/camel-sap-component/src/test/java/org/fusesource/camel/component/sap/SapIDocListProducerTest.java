...
public class SapIDocListProducerTest extends SapIDocTestSupport {
	...
	public void testProducer() throws Exception{ 
		...
		assertThat("Message header '" + SapConstants.SAP_SCHEME_NAME_MESSAGE_HEADER + "' returned unexpected value", exchange.getIn().getHeader(SapConstants.SAP_SCHEME_NAME_MESSAGE_HEADER, String.class), is(SapConstants.SAP_IDOC_LIST_DESTINATION));
	...
	protected RouteBuilder createRouteBuilder() throws Exception {
		return new RouteBuilder() {
			...
			public void configure() {
				from("direct:start").to("sap-idoclist-destination:TEST_DEST:TEST_IDOC_TYPE:TEST_IDOC_TYPE_EXTENSION:TEST_SYSTEM_VERSION:TEST_APPLICATION_VERSION").to("mock:result");
			}
		};
	}
}
