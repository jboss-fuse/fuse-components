 ...
 *
 */
public class ITestTransactionalServerCallAndPropagateException extends CamelSpringTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("sap-trfc-server:nplServer:PARAM_TEST?propagateExceptions=true").to("bean:throwUp").to("direct:out");
            }
        };
    }
