 ...
 *
 */
public class ITestSynchronousServerCallAndThrowException extends CamelSpringTestSupport {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("sap-srfc-server:nplServer:PARAM_TEST").to("bean:throwUp").to("direct:out");
            }
        };
    }
