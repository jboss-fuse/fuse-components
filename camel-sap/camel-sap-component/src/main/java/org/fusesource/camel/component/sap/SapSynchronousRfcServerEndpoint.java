 ...
 *
 */
@UriEndpoint(firstVersion = "3.20.1-redhat", scheme="sap-srfc-server", syntax = "sap-srfc-server:server:rfc", consumerOnly = true, title="SAP Synchronous RFC Server", category = { Category.SAAS })
