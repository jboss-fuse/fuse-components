...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TID Store</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class TIDStoreImpl extends EObjectImpl implements TIDStore {
	/**
	...
	protected EClass eStaticClass() {
		return RfcPackage.Literals.TID_STORE;
	}
	...
	public EMap<String, String> getEntries() {
		if (entries == null) {
			entries = new EcoreEMap<String,String>(RfcPackage.Literals.TID_STORE_ENTRY, TIDStoreEntryImpl.class, this, RfcPackage.TID_STORE__ENTRIES);
		}
		return entries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RfcPackage.TID_STORE__ENTRIES:
