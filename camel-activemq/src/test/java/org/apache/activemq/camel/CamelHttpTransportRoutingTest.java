...
public class CamelHttpTransportRoutingTest extends TestCase {

    private static final Logger log = LoggerFactory.getLogger(CamelHttpTransportRoutingTest.class);
    ...
    protected BrokerService createBroker() throws Exception {
        ...
        connector = service.addConnector("http://localhost:8080");
    ...
    private void createCamelContext() throws Exception {
        ...
        camelContext.addComponent("activemq",
                ActiveMQComponent.activeMQComponent("http://localhost:8080"));
